    ...
    return (
        <div className="w-full flex">
            <div className="flex flex-col flex-1">
                ...
                <div className="w-full py-8 px-4 flex justify-start gap-3">
                    {/* image upload */}
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <label className="">
                            ...
                            <input className="w-100 py-3 px-2 border border-[#bababa] rounded-lg bg-gray-50" type="text" placeholder="#hashtags" disabled={!image} />
                        </label>
