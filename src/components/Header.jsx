        ...
        <header className="w-full p-4 flex justify-between gap-5 max-[470px]:gap-3">
            ...
            <div className="flex items-center jusctify-center gap-3">
                <Link to={"auth/login"} className="h-full">
                    <button className="px-7 h-full bg-indigo-600 text-white rounded-lg cursor-pointer hover:bg-indigo-500 max-[400px]:hidden">login</button>
                </Link>
                <Link to={"auth/signup"} className="h-full max-[580px]:hidden">
                    <button className="px-7 h-full bg-indigo-600 text-white rounded-lg cursor-pointer hover:bg-indigo-500 max-[580px]:hidden">sign up</button>
                </Link>
            </div>
        </header>
    )
